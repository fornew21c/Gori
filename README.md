...
'GORI'는 "튜터와 튜티의 손쉬운 연결"이라는 기본 콘셉트 하에 구현하었습니다.  
...
- 강좌 리뷰  작성, 신청 시 일정 선택 및 저장, 신청 전 문의사항 전송
...
**FastCampus에서 제공한 UI파일**을 참고하였으며, **오토레이아웃**의 **Constraint** 설정을 위한 간격은 **Sketch**로 Import한 UI파일을 **Zeplin**으로 Export하여 확인했습니다.
